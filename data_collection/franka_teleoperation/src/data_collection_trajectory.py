...
class FrankaRobot(object):
    def __init__(self):
        ...
        self._visualization_sub = message_filters.Subscriber("/visualization", Image)
    ...
    def read_robot_data(self, robot_joint_data, bottom_cam, centr, visual):
