...
#include <franka_panda_controllers/franka_leader_impendance_controller.h>
...
bool LeaderCartesianImpedanceController::init(hardware_interface::RobotHW* robot_hw,
  ...
  dynamic_server_compliance_param_ = std::make_unique<
      dynamic_reconfigure::Server<franka_panda_controllers::leader_compliance_paramsConfig>>(
...
void LeaderCartesianImpedanceController::complianceParamCallback(
    franka_panda_controllers::leader_compliance_paramsConfig& config,
    uint32_t /*level*/) {
...
PLUGINLIB_EXPORT_CLASS(franka_panda_controllers::LeaderCartesianImpedanceController,
